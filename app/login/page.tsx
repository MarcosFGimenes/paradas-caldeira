  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 text-white">
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-4 py-10">
        <div className="mb-8 w-full max-w-3xl rounded-2xl border border-white/5 bg-slate-900/60 p-6 shadow-2xl shadow-emerald-500/10">
        ...
        <div className="grid w-full max-w-3xl gap-6 lg:grid-cols-[1.1fr,0.9fr]">
          <div className="space-y-6 rounded-2xl border border-white/5 bg-slate-900/70 p-6 shadow-2xl shadow-emerald-500/10">
            <div className="space-y-1">
              <p className="text-sm uppercase tracking-wide text-slate-400">Login</p>
              <h2 className="text-xl font-semibold text-white">Use seu e-mail corporativo</h2>
            </div>
